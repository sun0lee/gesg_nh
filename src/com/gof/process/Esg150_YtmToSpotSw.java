...
//	}
	...
	public static List<IrCurveSpot> createIrCurveSpot(String baseYmd, String irCurveId, List<IrCurveYtm> ytmRst, IrParamSw swSce) {		
		
		SmithWilsonKicsBts swBts = SmithWilsonKicsBts.of()
													 .baseDate(DateUtil.convertFrom(baseYmd))
													 .ytmCurveHisList(ytmRst)
													 .alphaApplied(swSce.getSwAlphaYtm())													 
													 .freq(swSce.getFreq())
													 .addTenor(swSce.getLlp().doubleValue())
													 .build();
