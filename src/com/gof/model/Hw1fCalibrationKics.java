...
@Setter
@Slf4j
public class Hw1fCalibrationKics extends IrModel {	
...
//				swpnVol.setBaseYymm(dateToString(baseDate));
...
//		                                                  , initParas, 2, 100, cmpdType, real, prjYear, 6, DCB_MON_DIF, 10, 1e-10);		
//		
//		
...
//	TODO: Main Function for Validation
	public List<IrValidParamHw> getValidationResult() {
		...
		double[]   sigma = new double[] {this.optParas[2], this.optParas[3], this.optParas[4], this.optParas[5], this.optParas[6], this.optParas[7]};		
...
//			log.info("i: {}, t1: {}, t2: {}, swpnDt[i]: {}, B^2(t1, t2): {}, Zeta: {}, swpnSigma: {}", i, t1, t2, swpnDt[i], Math.pow(coefB(t1, swpnDt[i], alpha), 2), coefZeta(t1, alpha, sigma), swpnSigma[i]);
	...
	protected void checkSwpnPriceHw() {
		...
		double[] initParas = new double[] {0.02, 0.02, 0.02, 0.02, 0.02, 0.02, 0.02, 0.02};
		double[] alpha     = new double[] {initParas[0], initParas[1]};
		double[] sigma     = new double[] {initParas[2], initParas[3], initParas[4], initParas[5], initParas[6], initParas[7]};
